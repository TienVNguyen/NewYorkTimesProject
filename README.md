...
* [ ] Replace all icon drawables and other static vector assets with [vector drawables](http://guides.codepath.com/android/Drawables#vector-drawables) where appropriate.
