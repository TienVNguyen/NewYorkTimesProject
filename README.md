...
* [ ] Improved the user interface and experiment with vector assets and/or styling and coloring
...
* [x] Replace all icon drawables and other static vector assets with [vector drawables](http://guides.codepath.com/android/Drawables#vector-drawables) where appropriate.
